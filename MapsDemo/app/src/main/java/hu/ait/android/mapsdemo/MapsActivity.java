package hu.ait.android.mapsdemo;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng budapest = new LatLng(47, 19);
        mMap.addMarker(new MarkerOptions().position(budapest).title("Marker in Budapest"));
