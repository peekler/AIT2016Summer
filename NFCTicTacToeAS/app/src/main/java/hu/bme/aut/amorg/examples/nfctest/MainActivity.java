		...
		if (ContextCompat.checkSelfPermission(this,
			...
			if (ActivityCompat.shouldShowRequestPermissionRationale(this,
				...
				Toast.makeText(MainActivity.this,
						"I need it for NFC", Toast.LENGTH_SHORT).show();
			}
		...
		switch (requestCode) {
			case 101: {
				...
				if (grantResults.length > 0
					...
					Toast.makeText(MainActivity.this, "NFC perm granted", Toast.LENGTH_SHORT).show();


				} else {
					Toast.makeText(MainActivity.this,
							"NFC perm NOT granted", Toast.LENGTH_SHORT).show();
				}
				return;
			}
		}
